...
function LeftSideContact()
{
 ...
 const contactInfo = [
  {
    title: 'Mobile Number',
    details: ['☏ (+91) 9674183723', '☏ (+91) 7044040384', '☏ (+91) 033-25005025'], 
  },
  {
    title: 'Office Address',
    details: ['Uttrayan Apartment,Ground Floor, RC No. 16/3,','Raghunathpur, Near Teghoriya Minibus Stand,',
  'Kolkata- 700059'
  ],
  },
...
return(
  ...
  <div className="rounded-l-[2vh]" style={{backgroundColor:"#8db8fc"}}>
          <h2 className="font-bold mt-8 mx-8 text-2xl">Call us 24X7</h2>
