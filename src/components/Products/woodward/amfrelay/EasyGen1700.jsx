...
import pdf from "./pdfs/easYgen-1700.pdf";

function EasyGen1700() {
  return (
        ...
        <div className="flex-1 h-full p-5 lg:pr-16 ">
          <div className="">
            ...
            <h3 className="pb-4 text-2xl font-bold text-gray-800 md:text-2xl lg:text-3xl">
              CONTROL-EASYGEN 1700{" "}
            </h3>
            <p className="pb-2 text-justify text-sm lg:text-base">
              The innovative features of the easYgen-1700 Series, including
          ...
          <div className="py-4 md:py-8">
            ...
            <h3 className="pb-2 text-justify text-sm lg:text-base">
              The Woodward easYgen-1700 series compact AMF controller based on
              easYgen-1800 platform without the ethernet and SD card
              connectivity with a large liquid crystal display (LCD), adequate
              I/Os and common industrial connectivity for a single-generator set
              used in critical stand-by or prime power applications with
              automatic changeover capability. The controllers include
              purpose-built algorithms and logic to start, stop, control, and
              protect the genset, open/close circuit breakers and mains supply
              monitoring with automatic changeover. Equipped with
              state-of-the-art communication interfaces, Woodward’s easYgen-1000
              Series of AMF genset controllers provides exceptional versatility
              and value for OEM genset packagers.
            </h3>
