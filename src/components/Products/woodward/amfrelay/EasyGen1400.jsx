...
import pdf from "./pdfs/easYgen-1400.pdf";
// import PDFViewer from './pdfs/pdf';

function EasyGen1400() {
        ...
        <div className="flex-1 h-full p-5 lg:pr-16 ">
          <div className="">
            ...
            <h3 className="pb-4 text-2xl font-bold text-gray-800 md:text-2xl lg:text-3xl">
              CONTROL-EASYGEN-1400{" "}
            </h3>
            <p className="pb-2 text-justify text-sm lg:text-base">
              The innovative features of the easYgen-1400 Series, including
          ...
          <div className="py-4 md:py-8">
            ...
            <h3 className="pb-2 text-justify text-sm lg:text-base">
              The Woodward easYgen-1400 series small AMF controller contains a
              big liquid crystal display (LCD), configurable I/Os and electronic
              engine support designed for a single-generator set used in
              critical stand-by or prime power applications with automatic
              changeover capability. The controllers include purpose-built
              algorithms and logic to start, stop, control, and protect the
              genset, open/close circuit breakers and mains supply monitoring
              with automatic changeover. Equipped with state-of-the-art
              communication interfaces, Woodward’s easYgen-1400 Series of AMF
              genset controllers provides exceptional versatility and value for
              OEM genset packagers.
            </h3>
