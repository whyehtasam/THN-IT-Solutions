...
import pdf from "./pdfs/easYgen-1600.pdf";

function EasyGen1600() {
  return (
        ...
        <div className="flex-1 h-full p-5 lg:pr-16 ">
          <div className="">
            ...
            <h3 className="pb-4 text-2xl font-bold text-gray-800 md:text-2xl lg:text-3xl">
              CONTROL-EASYGEN-1600(UL,CE){" "}
            </h3>
            <p className="pb-2 text-justify text-sm lg:text-base">
              The innovative features of the easYgen-1600 Series, including
          ...
          <div className="py-4 md:py-8">
            ...
            <h3 className="pb-2 text-justify text-sm lg:text-base">
              The Woodward easYgen-1600 series compact AMF controller contains a
              state of the art liquid crystal display (LCD), adequate I/Os and
              common industrial connectivity for a single-generator set used in
              ...
              communication interfaces, Woodward’s easYgen-1600 Series of AMF
