...
import pdf from "./pdfs/easYgen-3500XT.pdf";




function EasyGen3500XT() {
  return (
        ...
        <div className="flex-1 h-full p-5 lg:pr-16 ">
          <div className="">
            ...
            <h3 className="pb-4 text-2xl font-bold text-gray-800 md:text-2xl lg:text-3xl">
              CONTROL-EASYGEN-3500XT-P1-LT{" "}
            </h3>
            <p className="pb-2 text-justify text-sm lg:text-base">
              The easYgen-3500XT combines complete engine-generator control and
          ...
          <div className="py-4 md:py-8">
            ...
            <h3 className="pb-2 text-justify text-sm lg:text-base">
              Woodward’s easYgen-3500XT Series paralleling genset controllers
              provide exceptional versatility and value for OEM switchgear
              builders, generator packagers, and system integrators. The
              easYgen-3500XT combines complete engine-generator control and
              protection with advanced, peer-to-peer paralleling functionality
              and innovative features in a robust, attractive and user-friendly
            ...
            <h3 className="pb-2 text-justify text-sm lg:text-base">
              The easYgen-3500XT gives you the advantage of standardizing on a
            ...
            <h3 className="pb-2 text-justify text-lg font-bold lg:text-base">
              Common easYgen-3500XT applications:
            </h3>
            ...
            <h3 className="pb-4 text-lg font-bold">
              easYgen-3500XT Features & Benefits
            </h3>

            <p className="text-sm">
              All easYgen-3500XT Series models include these standard features:
              ...
              service tool Connectivity with the RP-3500XT Remote Panel for
              complete annunciation, control and configuration of the
              easYgen-3500XT controller, over CANopen protocol at up to 250m
            ...
            <h3 className="pb-4 text-lg font-bold">
              The easYgen-3500XT Series provide:
            </h3>
            ...
            <p className="text-sm">
              ...
              individual size Base loading, import/export control, asymmetrical
