...
const GetInTouch = ({ para,className }) => {
  ...
  return (
    <div className={"lg:p-10 lg:mb-12 grid  lg:mx-auto rounded-lg bg-white shadow-lg " + className}>
      <h1 className="md:text-4xl text-xl font-semibold text-start">Get in touch</h1>
