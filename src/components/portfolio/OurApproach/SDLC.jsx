    ...
    <>
      ...
      <div className="">
        ...
        <div className="w-full">
          <div className="items-center md:mx-auto m-2 md:w-[30%]">
            <li className="text-[15px] font-semibold py-[4%] text-slate-600 ">
              <b className="text-[18px] text-slate-800 text-justify">Planning :</b> In this
        ...
        <div className="md:flex grid md:justify-between gap-4 md:mx-[5%] m-2">
          <div className=" md:w-[30%]">
            <li className="text-[15px] font-semibold py-[4%] text-justify text-slate-600">
              <b className="text-[18px] text-slate-800 ">Analysis :</b> During
            ...
            <li className="text-[15px] font-semibold py-[4%] text-justify text-slate-600">
              <b className="text-[18px] text-slate-800 ">Design :</b> In the
            ...
            <li className="text-[15px] font-semibold py-[4%] text-justify text-slate-600">
              <b className="text-[18px] text-slate-800 ">Implementation</b> In
          ...
          <div className=" md:w-[30%]">
            <li className="text-[15px] font-semibold py-[4%] text-justify text-slate-600">
              <b className="text-[18px] text-slate-800 ">Testing :</b> Once the
            ...
            <li className="text-[15px] font-semibold py-[4%] text-justify text-slate-600">
              <b className="text-[18px] text-slate-800 ">Deployment :</b> After
            ...
            <li className="text-[15px] font-semibold py-[4%] text-justify text-slate-600">
              <b className="text-[18px] text-slate-800 ">Maintenance :</b> The
