...
function SDLC()
{
    ...
    return(
        ...
        <>
        <p className="mt-[2%] mb-[4%] mx-[5%]">The Software Development Life Cycle (SDLC) is a structured process used by software development teams to design, develop, test, deploy, and maintain software products. It provides a framework for managing the entire lifecycle of a software project from inception to retirement.</p>
