    ...
    <div className="flex gap-4 mx-16 mb-[5%] bg-white gap-top-5">
      <div className=" shadow-xl border-[2px] rounded-lg justify-center p-10  h-50 ">
        <div className="flex gap-2">
          <img
            src="/icin.png"
            alt=""
            className="h-[10vh] w-[5vw] rounded-[50%]"
          />
        ...
        <p className=" text-sm text-justify font-medium  text-gray-500">
          We are extremely pleased with the outcome of my website. THN IT
          Solutions delivered exactly what I envisioned, and the attention to
          detail is impeccable. Highly recommend their services!
        </p>
      ...
      <div className=" shadow-xl border-[2px] rounded-lg justify-center p-10  h-50 ">
        <div className="flex gap-2">
          ...
          <p className=" text-sm text-justify font-medium  text-gray-500">
            We could not be happier with the results. The website not only looks
            great but also functions seamlessly. The THN IT Solutions went above
            and beyond to ensure everything was perfect. Thank You!!
          </p>
          <div className="rating py-2 justify-center"></div>
        </div>
        <div className=" shadow-xl border-[2px] rounded-lg justify-center p-10  h-50 ">
          ...
          <p className=" text-sm text-justify font-medium  text-gray-500">
            Working with the THN IT Solutions was a breeze. They were
            responsive, creative, and professional throughout the entire
            process. My website looks fantastic, and I have already received
            compliments.
          </p>
          <div className="rating py-2 justify-center"></div>
        </div>
