  ...
  return (
    <section className="intro-cards h-auto   relative">
      ...
      <Container className={"w-full h-full justify-items-center grid lg:grid-cols-2 gap-8 p-2 " + props.containerStyle}>
        ...
        {data.map(({id,title,description}) => <div className={"mx-4 card h-auto bg-base-100 shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-300 " + props.cardStyle} key={id}>
