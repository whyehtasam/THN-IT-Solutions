...
const IntroBanner = (props) => {
  return (
    <section className="banner lg:pb-16 md:pb-8 md:px-14 lg:px-28 h-auto">
      <Container className="flex  justify-center items-center w-full h-28 lg:h-60 rounded-lg drop-shadow-md border-white bg-gradient-to-r from-gray-900 via-gray-700 to-black relative overflow-hidden">
        <img
          src={svg}
